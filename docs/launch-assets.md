...
| --- | --- | --- |
| Email | `steven@stevenbyington.me` | Confirmed from launch site data |
...
| Item | Path | Status |
| --- | --- | --- |
| Logo system sheet | `/assets/brand/logo-system.png` | Approved |
| Desktop header wordmark | `/assets/brand/steven-byington-wordmark.png` | Approved |
| Compact SB icon | `/assets/brand/sb-icon.png` | Approved |
| Favicon | `/favicon.png` | Approved |
| Apple touch icon | `/assets/brand/apple-touch-icon.png` | Approved |
| Primary logo lockup | `/assets/brand/logo-lockup.png` | Approved |
| Primary logo lockup cream crop | `/assets/brand/logo-lockup-cream.png` | Approved |
| Open Graph PNG | `/assets/brand/open-graph.png` | Approved |
| Open Graph SVG source | `/assets/brand/open-graph.svg` | Approved |
| Hero Landscape WebP | `/assets/hero/hero-landscape.webp` | Approved |
| Hero Landscape PNG fallback | `/assets/hero/hero-landscape.png` | Approved |
| Resume PDF | `/resume/steven-byington-resume.pdf` | Approved |

## Screenshot Review

| Project | Path | Status | Review notes |
| --- | --- | --- | --- |
| Aeris | `/assets/projects/aeris/chat-response.png` | Approved | User-provided screenshot reviewed with no addresses, precise locations, API keys, auth details, private notes, or sensitive financial details visible. |
| Aeris | `/assets/projects/aeris/chat-loading.png` | Approved | User-provided screenshot reviewed with no addresses, precise locations, API keys, auth details, private notes, or sensitive financial details visible. |
...
Generated for the launch hero in the brand palette: Forest Green `#1F3B2E`, Warm Cream `#F7F2E6`, and restrained Trail Orange `#D26A2E`.

The approved asset contains no visible people, animals, buildings, vehicles, signs, readable text, watermark, literal logo recreation, or `SB` letterform.
